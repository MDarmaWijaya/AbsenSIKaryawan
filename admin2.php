    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                    <h1 class="p-1">Data karyawan yang hadir</h1>
                    <table class='table table-dark'>
                        ...
                        include "koneksi.php";
                        $no = 1;
                        $ambildata = mysqli_query($koneksi, "SELECT * FROM tb_karyawan, tb_absen WHERE tb_karyawan.id_karyawan = tb_absen.id_karyawan");
                        ...
                        <h1 class="p-1">Data karyawan yang tidak hadir</h1>
                    <table class='table table-dark'>
                            <thead>
                                <tr>
                                <th scope='col'>No</th>
                        ...
                        include "koneksi.php";
                        $no = 1;
                        $ambildata = mysqli_query($koneksi, "SELECT * FROM tb_karyawan, tb_keterangan WHERE tb_karyawan.id_karyawan = tb_keterangan.id_karyawan");
                        while ($tampil = mysqli_fetch_array($ambildata)) {
                            echo"
