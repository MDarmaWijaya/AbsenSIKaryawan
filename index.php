  ...
  <head>
    ...
    <link rel="icon" href="img/logoabsensi.jpg" type="image/png">
      ...
      <footer class="footer-area section-gap">
        ...
        <div class="footer-bottom row align-items-center text-center text-lg-left">
          <p class="footer-text m-0 col-lg-8 col-md-12">
            ...
            </script> All rights reserved <i class="fa fa-heart" aria-hidden="true"></i> by <a href="#" target="_blank">darma</a>
          </p>
